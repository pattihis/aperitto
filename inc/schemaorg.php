 ...
 * ========================================================================== */
if ( ! function_exists( 'aperitto_schemaorg_html5_comment' ) ) :
	function aperitto_schemaorg_html5_comment( $comment, $args, $depth ) {
 ...
 * ========================================================================== */
if ( ! function_exists( 'aperitto_markup_schemaorg' ) ) :
	function aperitto_markup_schemaorg() {

		global $post;

		$markup   = ( is_single() && aperitto_get_theme_option( 'schema_mark' ) ) ? true : false;
		$logo     = ( $markup && aperitto_get_theme_option( 'markup_logo' ) ) ? aperitto_get_theme_option( 'markup_logo' ) : get_template_directory_uri() . '/img/logo.jpg';
		$adress   = ( $markup && aperitto_get_theme_option( 'markup_adress' ) ) ? aperitto_get_theme_option( 'markup_adress' ) : 'Russia';
		$phone    = ( $markup && aperitto_get_theme_option( 'markup_telephone' ) ) ? aperitto_get_theme_option( 'markup_telephone' ) : '+7 (000) 000-000-00';
