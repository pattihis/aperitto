 ...
 *
 * ======================================================================== */
function aperitto_customize_register_scripts() {

	/* CSS */
	wp_register_style(
		'aperitto-customizer-sortable-checkboxes-css',
		get_template_directory_uri() . '/inc/customizer/assets/sortable-checkboxes.css'
	);
	wp_register_style(
		'aperitto-customizer-child-design-css',
		get_template_directory_uri() . '/inc/customizer/assets/child-design.css'
	);

	/* JS */
	wp_register_script(
		'aperitto-customizer-sortable-checkboxes-js',
...
add_action( 'customize_controls_enqueue_scripts', 'aperitto_customize_register_scripts', 0 );
/* ======================================================================== */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Aperitto_Sortable_Checkboxes_WPCC extends WP_Customize_Control {

		/**
		 * Scripts for this control
		 */
		public function enqueue() {
			wp_enqueue_style( 'aperitto-customizer-sortable-checkboxes-css' );
			wp_enqueue_script( 'aperitto-customizer-sortable-checkboxes-js' );
		}
 ...
 * ======================================================================== */
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Aperitto_Child_Design_WPCC extends WP_Customize_Control {

		public function enqueue() {
			wp_enqueue_style( 'aperitto-customizer-child-design-css' );
		}
