...
function aperitto_customizer_init( $wp_customize ) {
	...
	$wp_customize->add_control(
		'display_logo_and_title_control',
		array(
	...
	if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
		$wp_customize->add_setting(
			APERITTO_OPTION . '[group_site_title]',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_key',
			)
		...
		$wp_customize->add_control(
			new Aperitto_Group_Title_Control(
				$wp_customize,
				'aperitto_group_site_title',
				array(
	...
	if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
		$wp_customize->add_setting(
			APERITTO_OPTION . '[group_description_title]',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_key',
			)
		...
		$wp_customize->add_control(
			new Aperitto_Group_Title_Control(
				$wp_customize,
				'aperitto_group_description_title',
				array(
	...
	if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
		$wp_customize->add_setting(
			APERITTO_OPTION . '[group_other_title]',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_key',
			)
	...
	if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
		$wp_customize->add_setting(
			APERITTO_OPTION . '[group_layout_title]',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_key',
			)
	...
	if ( function_exists( 'is_woocommerce' ) ) {
		...
		if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
			...
			$wp_customize->add_control(
				new Aperitto_Group_Title_Control(
					$wp_customize,
					'aperitto_group_woolayout_title',
					array(
	...
	if ( class_exists( 'Aperitto_Group_Title_Control' ) ) {
		$wp_customize->add_setting(
			APERITTO_OPTION . '[group_other_layout]',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_key',
			)
